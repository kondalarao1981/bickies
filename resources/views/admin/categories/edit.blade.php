...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <title>Bickies - Add New Category</title>
                                ...
                                <div class="row">
                                    <div class="col-sm-8 m-auto">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="card-header-2">
                                                    <h5 style="color: #0DA487;">Category Information</h5>
                                                </div>

                                                <form class="theme-form theme-form-2 mega-form" action="{{route('categories.update')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                        ...
                                        <label class="col-sm-3 col-form-label form-label-title">Category Image</label>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <button class="btn ms-auto theme-bg-color text-white" type="submit">Save Category</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
